...
p1617 = ggtree(btree, aes(color=group_1617), mrsd = '2018-09-29') +
  ...
  guide="none")  +
  geom_tippoint(aes(fill=ha_clade_1617), shape=21,  size=3, color="transparent") +
  ...
  geom_text(aes(label=clade_label), hjust=1, vjust=-0.3, fontface="bold") +
  coord_cartesian(clip = "off")
p1617 = flip(p1617, 293, 381)
p1617

saveRDS(p1617, "ha_tree_1617.rds")
ggsave("ha_tree_1617.png", height=6, width=5)
ggsave("ha_tree_1617.pdf", height=6, width=5)
...
p1617 = p1617 + scale_fill_manual(values = c("#F8766D", "#CD9600",
                  ...
                  na.value=NA,
                  guide="none")
ggsave("ha_tree_1617_nolegend.png", height=6, width=5)
ggsave("ha_tree_1617_nolegend.pdf", height=6, width=5)
...
p_tree = ggtree(btree, aes(color=group), mrsd = '2018-09-29') +
  scale_color_manual(values = c("#444444", 
                     ...
                     guide="none")  +
  geom_tippoint(aes(fill=ha_clade_1718), shape=21,  size=3, color="transparent") +
...
ggsave("ha_tree_1718.png", height=6, width=5)
ggsave("ha_tree_1718.pdf", height=6, width=5)
...
ggsave("ha_tree_1718_nolegend.png", height=6, width=5)
ggsave("ha_tree_1718_nolegend.pdf", height=6, width=5)
